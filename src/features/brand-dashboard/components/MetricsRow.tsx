  ...
  const metrics = [
    {
      ...
      value: '1.25k',
      currency: 'EGP',
      icon: <Coins className="w-5 h-5 text-[#AE6727]" />,
      change: '12%',
    ...
    },
    {
      ...
      value: '450',
      currency: 'EGP',
      icon: <Wallet className="w-5 h-5 text-[#AE6727]" />,
      change: '8%',
      changeSub: 'vs Last week',
    },
    {
      ...
      value: '1.5k',
      currency: '',
      icon: <UserPlus className="w-5 h-5 text-[#AE6727]" />,
      change: '5%',
      changeSub: 'vs Last week',
    },
    {
      ...
      value: '24',
      currency: '',
      icon: <ShoppingCart className="w-5 h-5 text-[#AE6727]" />,
